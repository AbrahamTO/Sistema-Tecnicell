        ...
        <ul class="list-unstyled components">
          <li class="active">
            <a href="#" class="principal"
              ><i class="material-icons">dashboard</i><span>Principal</span></a
            >
          </li>
          <li class="">
            <a href="#" class="client"
              ><i class="material-icons">person</i><span>Clientes</span></a
            >
          </li>

          <li class="">
            <a href="#" class="client"
              ><i class="material-icons">archive</i><span>Productos</span></a
            >
          </li>
        </ul>
      </nav>
